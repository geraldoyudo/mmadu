...
----
java -Dspring.profiles.active=prod -Dmmadu.identity.url=http://localhost:15553 -Dserver.port=15553 -Dmmadu.identity.db.uri=mongodb://localhost/mmadu_local_db -jar mmadu-identity-2.0.2-SNAPSHOT.jar
----
...
[source,sh,options="nowrap"]
----
java -Dspring.profiles.active=prod -Dmmadu.identity.url=http://localhost:15553 -Dserver.port=15551 -Dmmadu.registration.db.uri=mongodb://localhost/mmadu_local_db -jar mmadu-user-service-2.0.2-SNAPSHOT.jar
----
...
[source,sh,options="nowrap"]
----
java -Dspring.profiles.active=prod -Dmmadu.identity.url=http://localhost:15553 -Dserver.port=15552 -Dmmadu.user.db.uri=mongodb://localhost/mmadu_local_db -jar mmadu-registration-2.0.2-SNAPSHOT.jar
----
...
[source,sh,options="nowrap"]
----
docker pull geraldoyudo/mmadu-identity:2.0.2-SNAPSHOT
----
...
[source,sh,options="nowrap"]
----
docker run -it -p 15553:8080 -e MMADU_IDENTITY_DB_URI='http://localhost/mongodb' -e SPRING_PROFILES_ACTIVE=prod -e MMADU_IDENTITY_URL=http://localhost:15553 geraldoyudo/mmadu-identity:2.0.2-SNAPSHOT
----
...
[source,sh,options="nowrap"]
----
docker pull geraldoyudo/mmadu-user-service:2.0.2-SNAPSHOT
----
...
[source,sh,options="nowrap"]
----
docker run -it -p 15551:8080 -e MMADU_USER_DB_URI='http://localhost/mongodb' -e SPRING_PROFILES_ACTIVE=prod -e MMADU_IDENTITY_URL=http://localhost:15553 geraldoyudo/mmadu-user-service:2.0.2-SNAPSHOT
----
...
[source,sh,options="nowrap"]
----
docker pull geraldoyudo/mmadu-registration-service:2.0.2-SNAPSHOT
----
...
[source,sh,options="nowrap"]
----
docker run -it -p 15552:8080 -e MMADU_USER_DB_URI='http://localhost/mongodb' -e SPRING_PROFILES_ACTIVE=prod -e MMADU_IDENTITY_URL=http://localhost:15553 -e MMADU_USER_URL=http://localhost:15551 geraldoyudo/mmadu-registration:2.0.2-SNAPSHOT
----
