...
public class MmaduSecurityAutoConfiguration {
    ...
    public AuthenticationManagerResolver<String> tenantAuthenticationManagerResolver(
            ...
            MmaduJwtAuthenticationConverter jwtAuthenticationConverter
    ) {
        TenantBasedAuthenticationResolver resolver = new TenantBasedAuthenticationResolver();
        resolver.setDomainJwkSetUriResolvers(domainJwkSetUriResolvers);
        resolver.setJwtAuthenticationConverter(jwtAuthenticationConverter);
        return resolver;
    }
    ...
    public AuthenticationManagerResolver<HttpServletRequest> tenantBasedJwtIssuerAuthenticationManagerResolver(
        ...
        resolver.setIssuerAuthenticationManagerResolver(authenticationManagerResolver);
    ...
    static class DomainExtractorConfiguration {
        ...
        @Bean
        @Order(20)
        public DomainExtractor tenantBasedDomainExtractor(TenantExtractor tenantExtractor) {
